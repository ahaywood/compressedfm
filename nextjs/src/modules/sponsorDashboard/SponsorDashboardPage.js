...
const SponsorDashboardPage = () => {
  ...
  return (
    <StyledSponsorDashboardPage>
      ...
      <div className="box">
        <h3 className="number">30,489</h3>
        <h5>Total Listens</h5>
      </div>

      <div className="box">
        <h3 className="number">32,520</h3>
      ...
      <div className="contracts-invoices">
        ...
        {/* contract */}
        <div className="contract-status"><span>Attn</span></div>
        ...
        {/* invoice */}
        <div className="invoice-status"><span>Attn</span></div>
