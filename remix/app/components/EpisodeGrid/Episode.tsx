  ...
  return (
    ...
    >
      <div className="flex items-center">
        <span className="text-white font-mono text-lg tracking-wide mr-1 relative uppercase top-2">Episode</span>
      ...
      <h2 className="font-sans text-[48px] font-black leading-none m-0 mr-5 p-0 mb-3">
        <Link className="text-white underline-none hover:text-lavenderIndigo" to={`/episode/${slug.current}`}>
          {title}
        </Link>
      </h2>
      <h4 className="font-mono text-lg italic m-0 mb-4 p-0">{formatLongDate(publishedAt)}</h4>
