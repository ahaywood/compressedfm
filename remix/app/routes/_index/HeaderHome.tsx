...
const HeaderHome = ({ tags }: HeaderHomeProps) => {
  ...
  return (
    <div className="text-center pt-[50px] w-full md:pt-[110px]">
      <Navigation handleClick={handleClick} isShowing={navShowing} tags={tags} />
      <Hamburger navShowing={navShowing} className="fixed left-0 top-0 z-hamburger" onClick={handleClick} />

      <div>
        <h1 className="mx-auto mt-5 relative max-w-[65%] translate-x-[8%] md:max-w-[850px] md:pl-[140px] transform md:translate-x-[0]">
          <img alt="Compressed.fm logo" className="mb-5" src="/images/logo.svg" width="850" height="272" />
        </h1>
