...
import {
  FaqQuery,
  GettingStartedEpisodesQuery,
  PopularEpisodesQuery,
  siteSettingsQuery,
    ...
    <div>
      ...
      <section className="my-0 mx-mobilePadding md:mx-auto max-w-narrowPageWidth">
        ...
        <ol className="reasons-list pl-0 list-none md:pl-10">
          {siteSettings &&
            siteSettings.reasonsBehind.map(
              (item: { reason: [] }, index: number) => (
                <li
                  key={index}
                  className="pt-[10px] pb-[25ppx] pl-[42px] relative md:pl-[75px]"
                >
      ...
      <section className="mr-[25px] mb-[50px] max-w-narrowPageWidth md:mx-auto md:mb-[50px]">
        ...
        <div>
          <p className="large-body">
            Since we're web designers and developers, we care about this sort of
            thing.
          </p>
          <p>
          ...
          <div className="center pt-10 mx-0 mb-[65px] gap-x-20">
            <img
              src="/images/logo__remix@2x.png"
              alt="Remix"
              width="180"
              height="45"
            />
            <img
              src="/images/logo__sanity@2x.png"
              alt="Sanity"
              width="191"
              height="38"
            />
            <img
              src="/images/logo__vercel@2x.png"
              alt="Vercel"
              width="240"
              height="60"
            />
          </div>
          <h4 className="font-mono text-yellow uppercase text-lg text-left mb-3">
            Colors
          </h4>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 text-left font-[22px] leading-tight">
            <div className="font-sans font-bold">
              <h5 className="text-[36px] leading-tight mb-[10px] p-0">
                Greyclif
              </h5>
              <TypeSample />
            </div>
        ...
        <h4 className="font-mono text-yellow uppercase text-lg">
          On the Design Side
        </h4>
        <div className="flex gap-[10px] flex-col-reverse sm:flex-row sm:gap-[100px]">
          ...
          <div className="flex-1">
            <img
              src="/images/logo__medium@2x.png"
              alt="Medium"
              width="277"
              height="43"
            />
        ...
        <div className="flex gap-[10px] flex-col-reverse sm:flex-row sm:gap-[100px]">
          <div className="flex-1">
            ...
            <p>
              We’ve{" "}
              <a
                href="https://github.com/ahaywood/compressedfm"
                target="_blank"
                rel="noreferrer"
              >
          ...
          <div className="flex-1">
            <img
              src="/images/logo__github@2x.png"
              alt="GitHub"
              width="247"
              height="74"
            />
      ...
      {faqs.length > 0 && (
        <>
          <section className="mx-auto max-w-narrowPageWidth">
            <div className="text-center">
              <h2 className="section-heading mt-[36px] mb-[64px]">
                Frequently Asked Questions
              </h2>
            </div>
            {faqs.map((faq: Faq) => (
